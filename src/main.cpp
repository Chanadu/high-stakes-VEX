	...
	ez::as::auton_selector.autons_add(	//
		{
			...
			// {"Pure Pursuit Wait Until\n\nGo to (24, 24) but start running an intakeMotors once the robot passes (12, 24)",
			// odom_pure_pursuit_wait_until_example},
			// {"Boomerang\n\nGo to (0, 24, 45) then come back to (0, 0, 0)", odom_boomerang_example},
			// {"Boomerang Pure Pursuit\n\nGo to (0, 24, 45) on the way to (24, 24) then come back to (0, 0, 0)",
			// odom_boomerang_injected_pure_pursuit_example},
			// {"Measure Offsets\n\nThis will turn the robot a bunch of times and calculate your offsets for your tracking wheels.",
			// odom_boomerang_injected_pure_pursuit_example},
